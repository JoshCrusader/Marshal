...
<%@ page import="DuesAndFees.Model.PastDues" %>
                    ...
                    <div class="panel panel-default col-md-12" style = "height: 95%;">
                        <div class="panel-body">
                            ...
                            <% 
                                ...
                                PastDues pd = (PastDues)request.getAttribute("PastDues");
                                
                                if (pd.getAmount().size() != 0) {
                                
                                    for (int i = 0; i < pd.getAmount().size(); i++) {

                                        out.println("<tr>");
                                        out.println("<td>" + months.get(pd.getStartmonth().get(i)-1) + " " + pd.getStartyear().get(i) + "</td>");
                                        out.println("<td>" + months.get(pd.getEndmonth().get(i)-1) + " " +  pd.getEndyear().get(i) + "</td>");
                                        out.println("<td>" + pd.getAmount().get(i) + " Pesos</td>");
                                        out.println("</tr>");
