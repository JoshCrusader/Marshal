<%-- 
    Document   : ReqStickerOutErr
    Created on : 11 26, 17, 12:11:36 PM
    Author     : user
--%>
  ...
  <div class="py-5 text-white opaque-overlay" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/cover_restaurant.jpg&quot;);">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="" contenteditable="true">Request Vehicle Pass</h1>
          <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Error!</h4>
            <p class="mb-0">The inputted data you sent was either invalid or doesn't exist.</p>
          </div>
          <form class="" method="post" action="ReqVehicleSticker.jsp">
