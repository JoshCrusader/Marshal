<%-- 
    Document   : RegVehOutputErr
    Created on : 11 26, 17, 11:53:03 AM
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">  
		<div class="dropdown">
                    <a class="nav-link" href="vehicleform.jsp">User Vehicles</a>
  ...
  <div class="py-5 text-white opaque-overlay" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/form_red.jpg&quot;);">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="" contenteditable="true">Register Vehicle</h1>
          <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Error!</h4>
            <p class="mb-0">The userID you inputted doesn't exist.</p>
          </div>
