<%-- 
    Document   : VehicleListOutput
    Created on : 11 26, 17, 1:30:56 AM
          ...
          <div class="card">
            <div class="card-body p-5">
              ...
              <table class="table">
                ...
                <tbody>
                  <%
                      ViewVehicleList vvl=(ViewVehicleList)request.getAttribute("vvl");
                      ArrayList<UserVehicle> uv=vvl.getListOfFinalUserV();
                      
                      for(int i=0;i<uv.size();i++){
                          for(int j=0;j<uv.get(i).getVehicles().size();j++){
                              out.println("<tr>");
                              out.println("<td>"+uv.get(i).getVehicles().get(j).getPlatenum()+"</td>");
                              out.println("<td>"+uv.get(i).getVehicles().get(j).getModel()+"</td>");
                              out.println("<td>"+uv.get(i).getUser().getUserID()+"</td>");
                              out.println("<td>"+uv.get(i).getUser().getLname()+" "+uv.get(i).getUser().getFname()+" "+uv.get(i).getUser().getMame()+"</td>");
                              out.println("</tr>");
