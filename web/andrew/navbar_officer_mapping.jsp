	...
	<div class = "css-navbar"> 
		<div class = "css-burgerbun"><div class = "css-hamburger"><div  class = "css-burgerinside"></div></div></div>
                ...
                <div style="position:absolute;top:30%;left:5%;">
                    <a href="directory?destination=MapManagement">Map Management</a>&nbsp;&nbsp;
                    <a href="directory?destination=MapReqsManagement">Requests Management</a>
                </div>
	</div>
			...
			<ul class = "css-sidelist">
				...
				<li>
					<a href = "#"> SMS Management</a>
                                ...
                                <li>
					<a href = "directory?destination=MapManagement"> Community Maps</a>
				</li>
                                <li>
