    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vehicleform.jsp">List</a>
          </li>
          <li class="nav-item">
  ...
  <div class="py-5 text-white opaque-overlay" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/cover_restaurant.jpg&quot;);">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="text-gray-dark">Registered Vehicle</h1>
            <form class="" action="RegVecServ" method="post">
              <table class="table">
                <thead>
                  <tr>
                    <th>Plate No</th>
            ...
            User person = (User)request.getAttribute("user");
                ...
                while(rs.next()){
                    ...
                    out.println("<tr>");
                    out.println("<td> <label class='form-control-label'>Plate number: " + rs.getString(1) + "</label> </td>");
                    out.println("<td> <label class='form-control-label'>Model: " + rs.getString(2) + "</label> </td>");
                    out.println("<td> <label class='form-control-label'>Make: " + rs.getString(3) + "</label> </td>");
                    out.println("<td> <label class='form-control-label'>Year: " + rs.getInt(4) + "</label> </td>");
                    out.println("</tr>");
