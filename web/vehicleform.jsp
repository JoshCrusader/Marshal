  ...
  <div class="py-5 text-white opaque-overlay" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/cover_restaurant.jpg&quot;);">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="text-gray-dark">Type your user ID</h1>
          <p class="lead mb-4">Complete the field below</p>
          <form  method="post" action="NewServlet">
            <div class="form-group"><label class="form-control-label">User ID</label>
              <input name="userID" type="number" min="1" class="form-control" placeholder="1">
            </div>
