<%-- 
    Document   : viewVehicleList
    Created on : 11 25, 17, 3:36:03 PM
    Author     : user
--%>
        ...
        <div class="col-md-6" id="book">
          <div class="card">
            <div class="card-body p-5">
                ...
                <form action="VehicleListServ" method="POST">
                    Filter By:<br>
                    <select name="filter">
                        <option value="none">None</option>
                        <option value="banned">Banned Vehicles</option>
                        <option value="no sticker">No Sticker Vehicles</option>
                    </select>
                    <br>
